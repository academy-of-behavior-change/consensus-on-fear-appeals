...
First, threatening communication is appealing. [[[STUK VAN GILL INVOEGEN]]]
...
5. Perceived threat and fear are not the only determinants targeted by warning labels: they also target negative affect and disgust.

We countered each of these arguments as follows:

1. It is challenging to conduct experiments that have both high internal and external validity when studying the effects of threatening communications in large-scale health promotion campaigns (such as warning labels). However, this is not impossible, and this degree of difficulty does not elevate observational evidence to the level where it affords causal conclusions.
2. In the case of threatening communication, self-reports of reasoned behavioral determinants such as attitude and  intention have low validity. This is the case because

[[[AFMAKEN ETC- STUKJES VAN HIER BENEDEN HALEN EN HIER NEERZETTEN, EN DAN HIER BENEDEN VERWIJZEN NAAR BOVEN]]]

We will refer back to these points as we discuss each commentary below, in alphabetical order.
